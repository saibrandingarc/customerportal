      ...
      <v-row align="center" justify="center" style="height: 100vh;">
        <v-col cols="12" sm="8" md="4">
          <v-card>
            ...
            <v-card-title>
              <h2 class="text-h5 text-center">Forgot Password</h2>
            </v-card-title>
  
            <v-card-text>
              <v-form ref="form" v-model="valid" lazy-validation>
                <v-text-field v-model="email" label="Email" variant="outlined" :rules="[rules.required, rules.email]" required></v-text-field>
                <v-text-field v-if="!otpVerified" v-model="otp" label="OTP" variant="outlined" :rules="[rules.required]" type="text" required></v-text-field>
